...
package me.kamelajda.valorantstats.utils.language;
...
public enum LanguageType {
    ENGLISH("en_US", "English (US)", ZoneId.of("US/Central"), DiscordLocale.ENGLISH_US),
    POLISH("pl", "Polski", ZoneId.of("Europe/Warsaw"), DiscordLocale.POLISH);
